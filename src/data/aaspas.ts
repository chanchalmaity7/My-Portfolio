export const AASPAS_PLAY_STORE_URL =
  'https://play.google.com/store/apps/details?id=com.chanchal7.AasPas';

export const aaspasCaseStudy = {
  title: 'AasPas',
  subtitle: 'Hyperlocal service marketplace and realtime operations platform',
  shortDescription:
    'A production-grade mobile marketplace for local service booking, worker operations, multilingual AI booking help, live tracking, native voice calls, payments, wallet settlement, reviews, support, and admin workflows.',
  longDescription:
  ...
  heroMetrics: [
    { value: 'Solo built', label: 'End-to-end ownership across mobile, backend, native Android, and ops' },
    { value: '3 product surfaces', label: 'Customer app, worker app, and admin control layer' },
    { value: '12 languages', label: 'Localized mobile experience for real Indian service markets' },
    { value: 'Realtime + native', label: 'Socket rooms, FCM, maps, calling, lock-screen, and background flows' },
    { value: 'Wallet + payments', label: 'Advance fee, remaining due, worker earnings, commission, and settlement' },
    { value: 'Recovery-aware', label: 'Redis hot state with Mongo durability and route fallback behavior' },
  ],
  assets: {
  ...
  homePhoneScreens: [
    ...
    },
    {
      ...
      caption:
        'Minimum booking fee, payment method selection, and Razorpay-backed flow are handled inside a native-feeling customer checkout screen.',
    },
    {
      src: '/aaspas-showcase/app-screens/chatbot-ai.png',
      title: 'AI concierge',
      accent: 'Multilingual help',
      caption:
        'The AI-assisted concierge can understand user intent, return nearby workers, and guide bookings across multiple languages.',
    },
    {
      src: '/aaspas-showcase/app-screens/track-worker.png',
      title: 'Live tracking',
      accent: 'ETA and map state',
      caption:
    ...
    },
    {
      ...
      caption:
        'The worker surface centralizes jobs, earnings, support, and operating actions instead of acting like a passive profile-only app.',
    },
    {
  ...
  showcaseGallery: [
    ...
    {
      src: '/aaspas-showcase/app-screens/customer-home.png',
      title: 'Customer home and service discovery',
      caption:
    ...
    {
      src: '/aaspas-showcase/app-screens/beauty-services.png',
      title: 'Package selection by category',
      caption:
    ...
    {
      src: '/aaspas-showcase/app-screens/chatbot-ai.png',
      title: 'AI concierge in the real app',
      caption:
    ...
    {
      src: '/aaspas-showcase/app-screens/track-worker.png',
      title: 'Live worker tracking and work timer',
      caption:
    ...
    {
      src: '/aaspas-showcase/app-screens/wallet-overview.png',
      title: 'Wallet and payout visibility',
      caption:
    ...
    {
      src: '/aaspas-showcase/app-screens/earnings-breakdown.png',
      title: 'Per-job earnings breakdown',
      caption:
  ...
  homeProofBlocks: [
    {
      title: 'Marketplace-grade payment engine',
      detail:
    ...
    {
      title: 'Realtime tracking and location intelligence',
      detail:
    ...
    {
      title: 'Native Android communication layer',
      detail:
    ...
    {
      title: 'Operational depth beyond the main app',
      detail:
    ...
    {
      title: 'Multilingual AI booking assistance',
      detail:
  ...
  keySystems: [
    ...
    {
      title: 'AI booking and support assistant',
      description:
    ...
    {
      title: 'Live tracking and service radius',
      description:
    ...
    {
      title: 'Admin and support operations',
      description:
  ...
  productSurfaces: [
    {
      title: 'Customer app',
      tone: 'Trust, booking, payment, and visibility',
      summary:
    ...
    {
      title: 'Worker app',
      tone: 'Field operations, motion, and earnings',
      summary:
    ...
    },
    {
      ...
      tone: 'Business control and operational oversight',
      summary:
    ...
    },
    {
      ...
      tone: 'Realtime state, recovery, and infrastructure glue',
      summary:
  ...
  customerExperience: [
    'Service discovery and category-based booking',
    'Worker selection and profile viewing',
    'Live worker tracking with distance and ETA',
    'Call worker, payment summary, and booking history',
    'Support tickets, reviews, saved addresses, and profile stats',
    'App reinstall and login recovery for active booking state',
  ],
  workerExperience: [
    'Native incoming booking popup with accept and reject actions',
    'Automatic route preparation and live location sharing on acceptance',
    'Active job details, job timer, and booking state transitions',
    'Collect payment screen, earnings breakdown, and wallet settlement flow',
    'Availability, onboarding, service area, package, and document setup',
    'Realtime updates for booking changes, payment events, and customer actions',
  ],
  adminExperience: [
    'Operational booking visibility and manual support readiness',
    'Wallet, payout, and settlement awareness',
    'Notification flows and communication oversight',
    'Video/tutorial publishing and content operations',
    'Version-control support for rollout discipline',
    'User, worker, and service monitoring utilities',
  ],
  technicalArchitecture: [
    {
      ...
      items: ['React Native', 'React Native StyleSheet', 'Expo', 'TypeScript', 'React Navigation', 'AsyncStorage', 'i18next', 'offline-aware UX'],
    },
    {
      ...
      items: ['Node.js', 'Express.js', 'MongoDB', 'Mongoose', 'JWT auth', 'request validation', 'role-based APIs'],
    },
    {
      title: 'AI-assisted conversational layer',
      summary:
      ...
      items: ['multilingual assistant UX', 'intent-guided booking help', 'customer support automation', 'natural-language interaction'],
    },
    {
      title: 'Realtime event layer',
      summary:
      ...
      items: ['Socket.IO rooms', 'booking state events', 'worker location streaming', 'payment events', 'call lifecycle events'],
    },
    {
      title: 'Hot state and recovery',
      summary:
      ...
      items: ['Redis active state', 'route cache', 'latest worker location', 'Mongo recovery snapshots', 'cache-first fallback'],
    },
    {
      title: 'Native Android layer',
      summary:
      ...
      items: ['full-screen booking popup', 'incoming call activity', 'ongoing call notification', 'notification actions', 'background behavior'],
    },
    {
      ...
      items: ['Razorpay', 'Firebase FCM', 'Agora', 'Google Maps', 'Google Directions', 'cloud media/storage flows'],
    },
  ],
  moneySystems: [
